<?php
	...
	if (isset($_POST['ok'])) {
		...
		try{
			...
			$stmt = $conn->prepare("INSERT INTO orders (country, address, state_country, postal_zip, phone, message) VALUES (:country, :address, :state_country, :postal_zip, :phone, :message)");
						...
						<div class="row mb-5">
							<div class="col-md-12">
								...
								<div class="p-3 p-lg-5 border bg-white">
									...
									<div class="form-group">
										<button type="submit" name="ok" class="btn btn-black btn-lg py-3 btn-block" onclick="window.location='thankyou.php'">Place Order</button>
									</div>
